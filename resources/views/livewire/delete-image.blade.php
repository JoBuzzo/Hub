<div>
    <button class="font-medium text-red-600 cursor-pointer  hover:underline" x-data=''
            x-on:click.prevent="$dispatch('open-modal', 'delete-image{{ $image->id }}')">Deletar
    </button>
        ...
        <div class="relative p-6 text-gray-800 ">
            ...
            <form wire:submit.prevent='delete'>
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500">Tem certeza que deseja excluir essa imagem?</h3>
