    ...
    <div class="m-auto flex flex-col items-center justify-center  ">
        <div class="shadow-md first-letter:overflow-x-auto sm:rounded-lg max-xl:w-[700px] w-[1250px] max-sm:w-[360px] bg-white px-4 py-8 rounded-md">
            <div class="flex w-full items-center justify-between mb-4">
                <h1 class="text-2xl font-bold tracking-tight text-gray-900">Projetos</h1>
            ...
            <table class="w-full text-sm text-left text-gray-500">
                ...
                @foreach ($projects as $project)
                    <tr class="bg-white border-b">
                        ...
                        <td class="px-6 py-4">
                            <a class="text-blue-600 hover:underline" href="{{ $project->url }}" target="_blank">{{ $project->url }}</a>
                        </td>
