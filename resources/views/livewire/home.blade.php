<div class="max-w-full justify-center items-center pt-7">
    <div class="m-auto flex flex-col items-center justify-center">
        <div class="flex items-center gap-4 justify-center p-2 max-xl:flex-col max-sm:w-[360px]">
            ...
            <div
                ...
                <div class="flex mb-3 gap-2">
                    <div class="border border-2 border-[#04DBFD] "></div>
                    <h5 class=" text-2xl font-bold tracking-tight text-gray-900 m-">Sobre nós</h5>
                </div>

                <p class="mb-3 font-normal justify-between ">O objetivo do HUB Inova FEMA é oferecer aos
        ...
        <div class="max-xl:w-[700px] w-[1250px] max-sm:w-[360px] flex flex-col pt-7">
            <div id="imagens" class="flex p-4 gap-2 w-full mt-8 mb-8">
                <div class="border border-2 border-[#04DBFD] "></div>
...
<footer id="contato" class="bg-white pt-7 mt-12">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:flex-col">
            <img src="./images/fema_logo_azul.png" class="h-14 mb-8 w-44 " alt="Fema Logo"/>
            <div class="grid grid-cols-2 gap-4 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase">Endereço</h2>
                    <ul class="text-gray-600 font-medium">
                        <li class="mb-3">
                            <span>Av. Getúlio Vargas, 1200</span>
                        </li>
                        <li class="mb-3">
                            <span">Vila Nova Santana</span>
                        </li>
                        <li class="mb-3">
                            <span>Assis - SP</span>
                        </li>
                        <li>
                            <span>CEP: 19807-130</span>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="text-gray-600 font-medium">
                        <li class="mb-3">
                            <span>Prof. Dr. Alex Poletto: </span>
                            <span>alex.poletto@fema.edu.br</span>
                        </li>
                        <li class="mb-3">
                            <span>(18) 3302-1050 - Ramal: 1031</span>
                        </li>
                        <li>
                            <span>hubinova@fema.edu.br</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center "><?php echo date('Y') ?>
                    HUB INOVA - Fema©. Todos os direitos reservados.
                </span>
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="https://www.facebook.com/fema.assis" class="text-gray-500 hover:text-gray-900 ">
                ...
                <a href="https://www.instagram.com/fema.assis/" class="text-gray-500 hover:text-gray-900">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
              ...
              <span class="sr-only">Twitter p</span>
           </a> -->
            </div>
        </div>
    </div>
