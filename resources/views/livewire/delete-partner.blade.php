<div>
    <button class="font-medium text-red-600 cursor-pointer dark:text-red-500 hover:underline" x-data=''
        x-on:click.prevent="$dispatch('open-modal', 'delete-image{{ $partner->id }}')">Deletar</button>
    <x-modal name="delete-image{{ $partner->id }}">
        <div class="relative p-6 text-gray-800 dark:text-white">
            ...
            <form wire:submit.prevent='delete'>
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tem certeza que deseja excluir essa imagem?</h3>
