<div>
    <button class="font-medium text-red-600 cursor-pointer  hover:underline" x-data=''
            x-on:click.prevent="$dispatch('open-modal', 'delete-partner{{ $partner->id }}')">Deletar
    </button>
    <x-modal name="delete-partner{{ $partner->id }}">
        <div class="relative p-6 text-gray-800 ">
            ...
            <form wire:submit.prevent='delete'>
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500">Tem certeza que deseja excluir esse parceiro?</h3>
